...
public class LookingForSomeone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learn_looking_for_someone);

        toolbar = (Toolbar) findViewById(R.id.menu_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Looking for someone");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        webView1 = (WebView) findViewById(R.id.web_id);
        webView1.setWebChromeClient(new WebChromeClient());
        webView1.loadUrl("file:///android_asset/5.html");
