...
public class LearnEssentials extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learn_essentials);

        toolbar = (Toolbar) findViewById(R.id.menu_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Essentials");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        webView1 = (WebView) findViewById(R.id.web_id);
        webView1.setWebChromeClient(new WebChromeClient());
        webView1.loadUrl("file:///android_asset/3.html");
