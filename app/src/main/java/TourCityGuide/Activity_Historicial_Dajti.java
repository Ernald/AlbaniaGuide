...
public class Activity_Historicial_Dajti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__historicial__dajti);

        toolbar = (Toolbar) findViewById(R.id.menu_toolbar);
        //Activate action Bar
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Dajti");
        ...
        i1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(Activity_Historicial_Dajti.this, "ALERT!.\n This is an In-QUERY number ", Toast.LENGTH_LONG).show();
        ...
        i2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String info = "https://en.wikipedia.org/wiki/Dajti";
        ...
        i3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Uri gmmIntentUri = Uri.parse("https://www.google.com/maps/place/Dajti/@41.367447,19.9051182,14z/data=!3m1!4b1!4m5!3m4!1s0x135035a3263ee679:0xc97d4e5064bc04cb!8m2!3d41.3674489!4d19.9226278!5m1!1e4");
