 ...
 *   Last modified: 24/12/20 7:41 PM
 *
...
public class Activity_Foods_Raki_Rrushi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__foods__raki__rrushi);

        toolbar = (Toolbar) findViewById(R.id.menu_toolbar);
        //Activate action Bar
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Raki");
