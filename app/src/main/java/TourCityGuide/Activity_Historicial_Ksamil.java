...
public class Activity_Historicial_Ksamil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__historicial__ksamil);

        toolbar = (Toolbar) findViewById(R.id.menu_toolbar);
        //Activate action Bar
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Ksamil");
        ...
        i1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(Activity_Historicial_Ksamil.this, "ALERT!.\n This is an In-QUERY number ", Toast.LENGTH_LONG).show();
        ...
        i2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String info = "https://en.wikipedia.org/wiki/Ksamil";
        ...
        i3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Uri gmmIntentUri = Uri.parse("https://www.google.com/maps/place/Ksamil/@39.7696135,19.9858581,14z/data=!3m1!4b1!4m5!3m4!1s0x135b6bd1e3b36029:0x87cc14b3c8a2d66d!8m2!3d39.7636732!4d19.9943469");
