...
public class activity_shoppingPlaces_Etc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shopping_places_etc);
        ...
        i1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i1.setData(Uri.parse("tel: 068 202 0205 "));
        ...
        i2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String info = "https://www.topshop.al/";
        ...
        i3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Uri gmmIntentUri = Uri.parse("https://goo.gl/maps/yzTw4Mq1uzTNsrak8");
