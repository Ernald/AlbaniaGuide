...
public class Activity_Historical_Fieri extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__historical_fieri);

        toolbar = (Toolbar) findViewById(R.id.menu_toolbar);
        //Activate action Bar
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Fieri");
        ...
        i1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Activity_Historical_Fieri.this, "ALERT!.\n This is an In-QUERY number ", Toast.LENGTH_LONG).show();
        ...
        i2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String info = "https://en.wikipedia.org/wiki/Fier";
        ...
        i3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Uri gmmIntentUri = Uri.parse("https://www.google.com/maps/place/Fier/@40.7266134,19.54383,14z/data=!3m1!4b1!4m5!3m4!1s0x134552cebf98f1f3:0x618ca21503edeabc!8m2!3d40.727504!4d19.5627596");
